...
SWEP.Trivia_Desc = "High tech DC-15A Purge Blaster Rifle, preffered for long-range combat and general allround usage."
...
SWEP.IconOverride = "materials/entities/rw_sw_dc15a_purge.png"
