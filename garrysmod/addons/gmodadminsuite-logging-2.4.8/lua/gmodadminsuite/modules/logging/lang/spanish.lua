return {
	...
	Phrases = function() return {
		...
		-- Remove the duplicate key "settings"
		-- settings                    = "Ajustes",
		...
		Logs = {
			...
			darkrp_hit_accepted_2                          = "{1} aceptó un hit para {2} requerido por {3}",
			-- darkrp_hit_completed                           = "{1} completoó un hit para {2} requerido por {3}", -- Remove this line
			-- Remove the duplicate entry for "darkrp_hit_failed"
			...
			-- Remove the duplicate entry for "darkrp_demoted_afk"
			-- darkrp_demoted_afk                             = "{1} fue demoteado por estar AFK",
