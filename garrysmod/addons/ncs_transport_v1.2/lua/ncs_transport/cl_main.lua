...
local function AddLocationConfiguration(oldFrame, configurationID, quack)
    ...
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_locationName"))
    M_LABEL:Dock(TOP)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_locationIcon"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_distanceScaled"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_locationPrice"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_teamRestriction"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
    ...
    teamRestriction:AddColumn( NCS_SHARED.GetLang(nil, "TRANSPORT_teamRestriction"), 1 )
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_positionButton"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")

    local positionButton = S:Add("NCS_TRANSPORT_TextButton")
    positionButton:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_positionButton"))
    ...
    positionButton.DoClick = function(s)
        SendNotification(LocalPlayer(), NCS_SHARED.GetLang(nil, "TRANSPORT_positionSelectNotify"))
    ...
    SUBMIT:Dock(BOTTOM)
    SUBMIT:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_submitChanges"))
...
concommand.Add("ncs_transport_cfg", function(P)
    NCS_TRANSPORT.IsAdmin(LocalPlayer(), function(ACCESS)
        ...
        SIDE:AddPage("Settings", "JokvF2A", function()
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_randomizeVendor"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_vendorModel"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_vendorSave"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_addonPrefix"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_addonPrefixColor"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_soundsEnabled"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_takeoffSound"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_landingSound"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_pricingScale"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            SUBMIT.DoClick = function(s)    
                ...
                SendNotification(LocalPlayer(), NCS_SHARED.GetLang(nil, "TRANSPORT_updatedSettings"))

                surface.PlaySound("ncs/ui/activate.mp3")
            end
        end)

        SIDE:AddPage(NCS_SHARED.GetLang(nil, "TRANSPORT_adminLabel"), "6JrFWlz", function()
            if IsValid(P) then
                P:Clear()
            end
            ...
            -- Cami Time
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_camiEnabled"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
            M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
            ...
            NoCAMIFuckU = function()
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_adminGroups"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                M_LABEL:SetFont("NCS_TRANSPORT_configMenuLabel")
                ...
                TX_USERGROUP:SetPlaceholderText(NCS_SHARED.GetLang(nil, "TRANSPORT_adminGroups"))
                ...
                TX_UGLIST:Dock(FILL)
                TX_UGLIST:AddColumn( NCS_SHARED.GetLang(nil, "DEF_adminGroups"), 1 )
                TX_UGLIST:AddColumn( NCS_SHARED.GetLang(nil, "DEF_addedBy"), 2 )
        ...
        SIDE:AddPage("Locations", "7IMshKR", function()
            if IsValid(P) then
                P:Clear()
            end
            ...
            S.Paint = function(s, w, h)
                if countLocations <= 0 then
                    draw.SimpleText(NCS_SHARED.GetLang(nil, "TRANSPORT_noDestinations"), "NCS_TRANSPORT_FRAME_TITLE", w * 0.5, h * 0.4, colorRed, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                end
            end
                ...
                NCS_TRANSPORT.RequestLocationData(LocalPlayer(), function(LOCATIONS)
                    for k, v in pairs(LOCATIONS) do
                        ...
                        LB.Paint = function(self, w, h)
                            ...
                            local textSample = NCS_SHARED.GetLang(nil, "TRANSPORT_distanceFree")

                            if v.distanceScaled then 
                                textSample = NCS_SHARED.GetLang(nil, "TRANSPORT_distanceScaled")
                            else
                                if v.price > 0 then textSample = NCS_SHARED.FormatMoney(nil, v.price) end
                            end
                    ...
                    local SUBMIT = vgui.Create("NCS_TRANSPORT_TextButton", P)
                    SUBMIT:Dock(BOTTOM)
                    SUBMIT:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_addLocation"))
                    SUBMIT:SetTall(h * 0.1)
                    SUBMIT:DockMargin(w * 0.025, h * 0.02, w * 0.025, h * 0.025)
                    SUBMIT.DoClick = function(s)    
        ...
        SIDE:AddPage(NCS_SHARED.GetLang(nil, "TRANSPORT_support"), "A5YPY4p", function()
            if IsValid(P) then
                P:Clear()
            end
            ...
            SUBMIT:SetTall(h * 0.1)
            SUBMIT:DockMargin(w * 0.025, h * 0.02, w * 0.025, h * 0.025)
            SUBMIT:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_clickToOpen"))
...
net.Receive("NCS_TRANSPORT_OpenMenu", function()
    ...
    NCS_TRANSPORT.IsAdmin(LocalPlayer(), function(ACCESS)
        ...
        adminButton:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_manageAvailableDests"))
        ...
        adminButton.DoClick = function()
            ...
            listView:Dock(FILL)
            listView:AddColumn( NCS_SHARED.GetLang(nil, "TRANSPORT_locationName"), 1 )
    ...
    DISCORD:DockMargin(w * 0.025, h * 0.02, w * 0.025, h * 0.025)
    DISCORD:SetImageSize(3)
    DISCORD.data = {name = NCS_SHARED.GetLang(nil, "TRANSPORT_noLocationSelected")}
    DISCORD.PaintOver = function(s, w, h)
        ...
        if v.price or v.distanceScaled then
            ...
            if finalPrice > 0 then
                textSample = NCS_SHARED.FormatMoney(nil, finalPrice)
            end
        end
    ...
    LB:SetText(NCS_SHARED.GetLang(nil, "TRANSPORT_travelLabel"))
    LB:SetTall(h * 0.1)
    LB:Dock(BOTTOM)
    LB:SetMouseInputEnabled(true)
    ...
    LB.DoClick = function()
        ...
        local finalPrice = NCS_TRANSPORT.GetLocationPrice(LocalPlayer(), v.uid)
        if !NCS_SHARED.CanAfford(LocalPlayer(), nil, finalPrice) then return end
