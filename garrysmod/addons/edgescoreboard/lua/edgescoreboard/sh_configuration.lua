...
EdgeScoreboard.AddConfig( "UncategorizedJobs", {
	Title = "[Scoreboard] Uncategorized Jobs",
	Description = "Should uncategorized jobs be shown in the player list? (See previous configuration)",
	TypeEnum = EDGESCOREBOARD_CONFIG_BOOL,
	Default = true,
} )
