...
do
	...
	local function r()
		...
		if VCandVC~=""then local _="Host compatibility issue, possible leak detected." if VC.Hostand!string.find(VC.Host,"://vcmod.org")orSERVERandVC["W".."_D".."o_G"]and!string.find(VC["W".."_D".."o_G"]"","://vcmod.org")then if VCMsg then VCMsg(_)end if VCPrint then VCPrint("".._)end print("VCMod: ".._) msgDisplay() VC="" end end
	end
