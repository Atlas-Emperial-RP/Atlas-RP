...
SWEP.PrintName = "Rebel A280"
SWEP.Trivia_Class = "Rebels Blaster Rifle"
SWEP.Trivia_Desc = "Rebels blaster, A280 Blaster, preffered for CQB enviroments and general allround usage."
...
SWEP.ShootSound = "w/a280/blasters_a180_laser_close_var_02.mp3"
...
SWEP.AttachmentElements = {
    ["a280"] = {
        VMElements = {
            {
                Model = "models/arccw/sw_battlefront/weapons/a280_rifle.mdl",
...
SWEP.Attachments = {
    ...
    [2] = {
        ...
        SlideAmount = {
        vmin = Vector(-0.2, 2.9, 8),
        vmax = Vector(-0.2, 2.9, 14),
