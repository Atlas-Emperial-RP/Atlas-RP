...
SWEP.Category = "[ Atlas ] DEV Custom Weapons [ DO NOT TOUCH!! ]" -- edit this if you like
SWEP.AdminOnly = false

SWEP.PrintName = "Rocket Jumper"
SWEP.TrueName = "RPS-6 Launcher"
SWEP.Trivia_Class = "Rocket Launcher"
SWEP.Trivia_Desc = "This is a toy for the DEVs and should not be used in normal gameplay."
