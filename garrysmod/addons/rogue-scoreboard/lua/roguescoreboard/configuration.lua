...
-- Server title
Configuration.ServerTitle           = "A T L A S  N E T W O R K S"
...
Configuration.RankDisplay["VIP"]           = { DisplayName = "VIP", TagName = "VIP", DisplayColor = Color( 232,185,35 ), TagColor = Color( 232,185,35 ) }
Configuration.RankDisplay["tgamemaster"]           = { DisplayName = "Trial Gamemaster", TagName = "TRIAL GAMEMASTER", DisplayColor = Color( 0,102,0 ), TagColor = Color( 0,102,0 ) }
Configuration.RankDisplay["tmod"]           = { DisplayName = "Trial Mod", TagName = "TRIAL MODERATOR", DisplayColor = Color( 0,102,0 ), TagColor = Color( 0,102,0 ) }
Configuration.RankDisplay["gamemaster"]           = { DisplayName = "Gamemaster", TagName = "GAMEMASTER", DisplayColor = Color( 153,153,0 ), TagColor = Color( 153,153,0 ) }
Configuration.RankDisplay["mod"]           = { DisplayName = "Moderator", TagName = "MODERATOR", DisplayColor = Color( 51,255,51 ), TagColor = Color( 51,255,51 ) }
Configuration.RankDisplay["headgamemaster"]          = { DisplayName = "Head Gamemaster", TagName = "HEAD GAMEMASTER", DisplayColor = Color( 128,0,128 ), TagColor = Color( 128,0,128 ) }
Configuration.RankDisplay["admin"]          = { DisplayName = "Administrator", TagName = "ADMINISTRATOR", DisplayColor = Color( 0,0,255 ), TagColor = Color( 0,0,255 ) }
Configuration.RankDisplay["sadmin"]          = { DisplayName = "Senior Administrator", TagName = "SADMINISTRATOR", DisplayColor = Color( 0,128,255 ), TagColor = Color( 0,128,255 ) }
Configuration.RankDisplay["Management"]      = { DisplayName = "Managment", TagName = "MANAGEMENT", DisplayColor = Color( 255, 51, 153 ), TagColor = Color( 255, 51, 153 ) }
Configuration.RankDisplay["superadmin"]     = { DisplayName = "Owner", TagName = "OWNER", DisplayColor = Color( 255,102,255 ), TagColor = Color( 255,102,255 ) }
...
Configuration.RankDisplay["OwnerDONTUSE"]          = { DisplayName = "OwnerDONTUSE", TagName = "OWNERDONTUSE", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
