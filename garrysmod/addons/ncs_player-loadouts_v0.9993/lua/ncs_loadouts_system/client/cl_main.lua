...
local function CreateLoadout(oldFrame, UID, CB)
    ...
    F:Center()
    F:SetTitle(NCS_SHARED.GetLang(nil, "LOADOUTS_addonTitle"))
    ...
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_loadoutName"))
    M_LABEL:Dock(TOP)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_loadoutIcon"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_loadoutHealth"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_loadoutArmor"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    if DarkRP then
        local M_LABEL = S:Add("DLabel")
        M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_loadoutSalary"))
        M_LABEL:Dock(TOP)
        M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_allTeamsEnabled"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_teamAvailability"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    d_TEAMS:AddColumn(NCS_SHARED.GetLang(nil, "LOADOUTS_teamAvailability"), 1)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_certRequirements"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    d_CERTS:AddColumn(NCS_SHARED.GetLang(nil, "LOADOUTS_certRequirements"), 1)
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_steamIDRestrict"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    ...
    d_SteamID64Text:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_steamID"))
    ...
    d_SteamID64List:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_steamID"), 1 )
    d_SteamID64List:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_steamName"), 2 )
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_loadoutWeapons"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    M_LABEL:SetMouseInputEnabled(true)
    ...
    d_WEAPONS:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_weaponClass"))
    ...
    d_WEAPONSL:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_weaponName"), 1 )
    d_WEAPONSL:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_weaponClass"), 2 )
    ...
    local M_LABEL = S:Add("DLabel")
    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_loadoutModels"))
    M_LABEL:Dock(TOP)
    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
    M_LABEL:SetMouseInputEnabled(true)
    ...
    d_ModelTextEntry:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_modelPath"))
    ...
    d_TeamTextEntry:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_selectTeams"))
    ...
    d_TeamTextEntry:AddChoice(NCS_SHARED.GetLang(nil, "LOADOUTS_allTeams"), "ALL")
    ...
    d_ModelListView:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_modelPath"), 1 )
    d_ModelListView:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_teamCount"), 2 )
    ...
    LABEL_customCode:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_customCodeExecute"))
    ...
    SUBMIT:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_submitLabel"))
...
local function AdmLoadout(oldFrame)
    ...
    NCS_LOADOUTS.IsAdmin(LocalPlayer(), function(ACCESS)
        ...
        if ACCESS or newAccess then
            SB:AddPage(NCS_SHARED.GetLang(nil, "LOADOUTS_playersLabel"), "cEmntWn", function()
                M_PANEL:Clear()
        ...
        if ACCESS then
            SB:AddPage(NCS_SHARED.GetLang(nil, "LOADOUTS_settingsLabel"), "svNpHqn", function()
                M_PANEL:Clear()
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_vendorModel"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_menuCommand"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_saveVendorCommand"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_accessOptions"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                local OPTIONS = {[1] = "LOADOUTS_allAccessible", [2] = "LOADOUTS_onlyCommand", [3] = "LOADOUTS_onlyVendor"}

                for k, v in ipairs(OPTIONS) do
                    local NAME = NCS_SHARED.GetLang(nil, v)
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_prefixText"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_prefixColor"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_rankRestrictCerts"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                BRANCH:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_branchLabel"))
                BRANCH:SetWide(BRANCH:GetWide() * 2)
            
                RANK = vgui.Create("DTextEntry", LABEL)
                RANK:Dock(LEFT)
                RANK:SetKeyboardInputEnabled(true)
                RANK:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_rankLabel"))
                ...
                vgui_rankMenu:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_branchLabel"), 1 )
                vgui_rankMenu:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_rankLabel"), 2 )
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_teamRestrictCerts"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                V_teamRestrictCerts:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_teamRestrictCerts"), 1 )
                ...
                -- Cami Time
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_showdisabledloadouts"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_forcedRespawn"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                SUBMIT:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_saveSettings"))
                SUBMIT.DoClick = function()
                    local json = util.TableToJSON(DATA)
                    local compressed = util.Compress(json)
                    local length = compressed:len()
            ...
            SB:AddPage(NCS_SHARED.GetLang(nil, "LOADOUTS_adminLabel"), "6JrFWlz", function()
                ...
                -- Cami Time
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_camiEnabled"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                NoCAMIFuckU = function()
                    local M_LABEL = S:Add("DLabel")
                    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_adminGroups"))
                    M_LABEL:Dock(TOP)
                    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                    M_LABEL:SetMouseInputEnabled(true)
                    ...
                    TX_USERGROUP:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_adminGroups"))
                    ...
                    TX_UGLIST:Dock(FILL)
                    TX_UGLIST:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_adminGroups"), 1 )
                    TX_UGLIST:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_addedBy"), 2 )
            ...
            SB:AddPage("Loadouts", "x53KTMQ", function()
                ...
                SP.PaintOver = function(s, w, h)
                    if loadoutsCount <= 0 then
                        draw.SimpleText(NCS_SHARED.GetLang(nil, "LOADOUTS_noAvailableLoadouts"), "NCS_LOD_FRAME_TITLE", w * 0.5, h * 0.4, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                    end
                end
                ...
                AddLoadout:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_addLoadout"))
            ...
            SB:AddPage("Certs", "UGpxlzI", function()
                ...
                SP.PaintOver = function(s, w, h)
                    if certCount <= 0 then
                        draw.SimpleText(NCS_SHARED.GetLang(nil, "LOADOUTS_noAvailableCerts"), "NCS_LOD_FRAME_TITLE", w * 0.5, h * 0.4, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                    end
                end
                ...
                CreateCertification = function(OLDFRAME, UID)
                    ...
                    local M_LABEL = S:Add("DLabel")
                    M_LABEL:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_seatsRestriction"))
                    M_LABEL:Dock(TOP)
                    M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                    ...
                    TE_CLASS:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_classLabel"))
                    TE_CLASS:SetWide(TE_CLASS:GetWide() * 2)
                
                    TE_SEATS = vgui.Create("DTextEntry", LABEL)
                    TE_SEATS:Dock(LEFT)
                    TE_SEATS:SetKeyboardInputEnabled(true)
                    TE_SEATS:SetPlaceholderText(NCS_SHARED.GetLang(nil, "LOADOUTS_seatsLabel"))
                    ...
                    DL_VehicleRestrict:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_classLabel"), 1 )
                    DL_VehicleRestrict:AddColumn( NCS_SHARED.GetLang(nil, "LOADOUTS_seatsLabel"), 2 )
                ...
                local AddLoadout = M_PANEL:Add("NCS_LOD_TextButton")
                AddLoadout:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_addCertification"))
                AddLoadout:Dock(BOTTOM)
                AddLoadout:SetTall(h * 0.1)
            ...
            SB:AddPage(NCS_SHARED.GetLang(nil, "LOADOUTS_supportLabel"), "A5YPY4p", function()
                if IsValid(M_PANEL) then
                    M_PANEL:Clear()
                end
                ...
                SUBMIT:SetTall(h * 0.15)
                SUBMIT:DockMargin(w * 0.025, h * 0.02, w * 0.025, h * 0.025)
                SUBMIT:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_clickToOpen"))
                SUBMIT.DoClick = function()
...
net.Receive("NCS_LOADOUTS_MenuOpen", function()
    ...
    NCS_LOADOUTS.IsAdmin(LocalPlayer(), function(ACCESS)        
        ...
        if ACCESS or newAccess then
            ...
            ADM:Dock(BOTTOM)
            ADM:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_adminLabel"))
            ADM:SetTall(h * 0.055)
    ...
    UNEQUIP:Dock(BOTTOM)
    UNEQUIP:SetText(NCS_SHARED.GetLang(nil, "LOADOUTS_unequipLabel"))
